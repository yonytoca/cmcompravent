...
Public Class FacturaImprimir
    ...
    Public Shared Sub Main()
        ...
        Application.Run(New FacturaImprimir())
    End Sub
    ...
    Public Sub PopulateDataGridView(Dato As DataGridView)
    ...
    Private Sub FacturaImprimir_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        SetupLayout()
        SetupDataGridView()
